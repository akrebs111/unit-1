...
var myData;
//creates the debugAjax function, which will retrieve the MegaCities.geojson file 
function debugAjax() {
    fetch('data/MegaCities.geojson')
        ...
        .then(function(response) {
            myData = response; //MegaCities data stored in myData in geojson format
            console.log(myData);
            callback(response); //callback function to allow the data to be accessed in other parts of the code
        })
}
//function which uses the data to print the text "GeoJSON data:" then a break line, followed by all of the data retrieved from the MegaCities.geojson
...
//loads webpage when the function debugAjax is called
